...
const DriversHome = () => {
  ...
  useEffect(() => {
    const fetchAssignedOrders = async () => {
      try {
        ...
        const ordersQuery = query(ordersCollection, where('driverInfo.id', '==', currentUser.uid));
  ...
  const pendingOrder = assignedOrders.find(order => order.status !== 'Delivered' && order.status !== 'Picked Up');
